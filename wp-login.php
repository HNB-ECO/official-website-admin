...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	$login_title = sprintf( __( '%1$s &lsaquo; %2$s &#8212; Joninear.com' ), $title, $login_title );
	...
	<body class="login <?php echo esc_attr( implode( ' ', $classes ) ); ?>" style="background-color: #eee;">
	<?php
	/**
	...
	?>
	<div id="login">
		<h1><a href="<?php echo esc_url( $login_header_url ); ?>" title="<?php echo esc_attr( $login_header_title ); ?>" tabindex="-1" style="background-image:none;text-indent: 0;width:100%;line-height: 84px;">欢迎登录HNB后台管理系统</a></h1>
	<?php
